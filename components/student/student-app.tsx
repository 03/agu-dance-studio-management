...
import { CalendarDays, Ticket, CreditCard, User, ChevronLeft, ScrollText, Bot } from "lucide-react"
import { cn } from "@/lib/utils"
import type { StudentAppData } from "@/lib/data"

type Tab = "schedule" | "bookings" | "cards" | "reviews" | "ai" | "me"
...
const tabs: { key: Tab; labelKey: string; Icon: typeof CalendarDays }[] = [
  ...
  { key: "ai", labelKey: "stu.nav.ai", Icon: Bot },
      ...
      <div className="mx-auto max-w-sm px-4">
        ...
        <MobileFrame>
          <div className="flex h-full flex-col bg-background">
            ...
            <nav className="grid grid-cols-6 border-t border-border bg-card">
